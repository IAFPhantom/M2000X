...
#ifdef _EXPORT_ED_FM_PHYSICS_IMP
...
extern "C"
{
	...
	*/
	ED_FM_TEMPLATE_API void ed_fm_wind_vector_field_update_request(wind_vector_field& in_out);
	ED_FM_TEMPLATE_API void ed_fm_wind_vector_field_done();
	...
	*/
	ED_FM_TEMPLATE_API void ed_fm_set_draw_args_v2(float* array, size_t size);
	ED_FM_TEMPLATE_API void ed_fm_set_fc3_cockpit_draw_args_v2(float* array, size_t size);
	...
	*/
	ED_FM_TEMPLATE_API void ed_fm_set_draw_args(EdDrawArgument* array, size_t size);
	ED_FM_TEMPLATE_API void ed_fm_set_fc3_cockpit_draw_args(EdDrawArgument* array, size_t size);
...
*/
	...
	*/
	...
	ED_FM_TEMPLATE_API void ed_fm_set_plugin_data_install_path(const char*);

	// damages and failures
	// void ed_fm_on_planned_failure(const char * ) callback when preplaneed failure triggered from mission 
	ED_FM_TEMPLATE_API void ed_fm_on_planned_failure(const char*);
